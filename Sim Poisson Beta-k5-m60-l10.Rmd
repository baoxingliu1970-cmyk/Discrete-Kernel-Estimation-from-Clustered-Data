---
title: "Sim Poisson Beta-k5-m60-l10"
author: "Baoxing Liu"
date: "`r Sys.Date()`"
output:
...
write.csv(mse_all_df,  "mse_results_poisson_beta_k5_m60_l10.csv",  row.names = FALSE)
write.csv(mise_all_df, "mise_results_poisson_beta_k5.m60_l10.csv", row.names = FALSE)
