---
title: "Sim Parallel Poisson Gamma-k5-m40"
author: "Baoxing Liu"
date: "`r Sys.Date()`"
output:
...
write.csv(mse_all_df, "mse_results_k5_m40.csv", row.names = FALSE)
write.csv(mise_all_df, "mise_results_k5_m40.csv", row.names = FALSE)
