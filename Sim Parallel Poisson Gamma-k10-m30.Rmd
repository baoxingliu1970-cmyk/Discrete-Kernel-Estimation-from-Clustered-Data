---
title: "Sim Parallel Poisson Gamma-k10-m30"
author: "Baoxing Liu"
date: "`r Sys.Date()`"
output:
...
write.csv(mse_all_df, "mse_results_k10_m30.csv", row.names = FALSE)
write.csv(mise_all_df, "mise_results_k10_m30.csv", row.names = FALSE)
