---
title: "Sim Poisson Beta-a1-b2-l10-k5"
author: "Baoxing Liu"
date: "`r Sys.Date()`"
output:
...
write.csv(mse_all_df,  "mse_results_poisson_beta_a1_b2_l10_k5.csv",  row.names = FALSE)
write.csv(mise_all_df, "mise_results_poisson_beta_a1.b2_l10_k5.csv", row.names = FALSE)
